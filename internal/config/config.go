...
type Auth0 struct {
	...
	// NativeClientID is the client ID of the Native Auth0 application used by
	// the mobile app. ID tokens it mints are verified against this audience by
	// the /auth/native exchange endpoint.
